...
if os_type.startswith('Windows'):
    ...
    binaries.append( ('/usr/local/Cellar/cairo/1.16.0_5/lib/libcairo.dylib', '.') )
    binaries.append( ('/usr/local/Cellar/cairo/1.16.0_5/lib/libcairo.2.dylib', '.') )
    binaries.append( ('/usr/local/Cellar/cairo/1.16.0_5/lib/libcairo-gobject.dylib', '.') )
    binaries.append( ('/usr/local/Cellar/cairo/1.16.0_5/lib/libcairo-gobject.2.dylib', '.') )
