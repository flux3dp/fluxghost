...
def find_blob_centers(img, min_threshold=10, max_threshold=200 , min_area=15, max_area=1000, min_circularity=0.64, max_circularity=None, min_convexity=0.85, max_convexity=None, draw=False):
    '''
